...
abstract class Colora {
  ...
  static const primaryColor = Color.fromARGB(255, 10, 25, 146); //buttom colors
  static const lightBlue =
      Color.fromARGB(255, 37, 55, 197); //blue textfileds colors
  static const borderAvatar = Color.fromARGB(255, 64, 90, 235);
  static const borderTag = Color.fromARGB(255, 8, 23, 136);
  static const backgoundDialog = Color.fromARGB(200, 9, 24, 143);
