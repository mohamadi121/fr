...
class _LocationInfoState extends State<LocationInfo> {
  ...
  final stateConroller = TextEditingController();
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            CustomTextField(controller: countryController, text: "کشور"),
            const SizedBox(height: 7),
            CustomTextField(controller: stateConroller, text: "استان"),
            const SizedBox(height: 7),
